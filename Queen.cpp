...
std::vector<std::string> Queen::availableMoves(std::string key)
{
...
std::vector<int> Queen::getPositionIndexes(char col, int row) {
...
std::string Queen::getPositionKey(int col_pos, int row_pos) {
	std::vector <int> rows = { 1, 2, 3, 4, 5, 6, 7, 8 };
	std::vector <char> cols = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h' };
	std::string move = "";
